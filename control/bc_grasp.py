...
class BCReachInfer(ArmBaseViewer):
    def __init__(self, render_path, model_path="bc_reach_best_model.pth"):
        ...
        self.bc_model.load_state_dict(torch.load(model_path, map_location=self.device))
        self.bc_model.eval()
...
if __name__ == '__main__':
    ...
    MODEL_PATH = '/home/ethan/work/mujoco-learning-main/bc_reach_best_model.pth'
