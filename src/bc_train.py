...
DATASET_PATH = ARTIFACTS_DIR / "bc_reach_dataset.pkl"
MODEL_SAVE_PATH = ARTIFACTS_DIR / "bc_reach_final_model.pth"      # 最终模型
BEST_MODEL_SAVE_PATH = ARTIFACTS_DIR / "bc_reach_best_model.pth"  # 最优模型（重点用这个）
PLOT_SAVE_PATH = ARTIFACTS_DIR / "bc_loss_curve.png"              # 损失曲线保存路径
